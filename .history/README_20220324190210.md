...
Null hypothesis (H0): the true mean difference is equal to zero (between the observations)Alternative hypothesis(H1): the true mean difference is not equal to zero (two-tailed)
## Basics   
