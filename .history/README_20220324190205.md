...
When performing dependent sample t-tests you typically have the following two hypotheses:Null hypothesis (H0): the true mean difference is equal to zero (between the observations)
