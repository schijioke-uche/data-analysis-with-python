...
Usage in Hypothesis Determination:
For, example, it could be use when performing dependent sample t-tests you typically have the following two hypotheses:
1. Null hypothesis (H0): the true mean difference is equal to zero (between the observations)
2. Alternative hypothesis(H1): the true mean difference is not equal to zero (two-tailed)
## Basics   
